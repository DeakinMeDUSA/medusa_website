...
(function (root, factory) {
  ...
  return function (opts) {
    ...
    this.get = function (callback) {
      var url = this.is_tag ? this.options.host + 'explore/tags/' + this.options.tag + '/' : this.options.host +
    ...
    this.display = function (data) {
      ...
      if (this.options.styling) {
        ...
        styles = {
          ...
          'gallery_image_link': ' style=\'width:' + width + '%; margin:' + this.options.margin +
      ...
      if (this.options.display_profile) {
        ...
        html += '<img class=\'instagram_profile_image\'' + (this.options.lazy_load ? ' loading=\'lazy\'' : '') +
          ' src=\'' +
          data.profile_pic_url + '\' alt=\'' + (this.is_tag ? data.name + ' tag pic' : data.username + ' profile pic') +
          ' profile pic\'' + styles.profile_image + ' />'
        if (this.is_tag)
          html += '<p class=\'instagram_tag\'' + styles.profile_name +
            '><a href=\'https://www.instagram.com/explore/tags/' + this.options.tag +
            '\' rel=\'noopener\' target=\'_blank\'>#' + this.options.tag + '</a></p>'
        else
          html += '<p class=\'instagram_username\'' + styles.profile_name + '>@' + data.full_name +
            ' (<a href=\'https://www.instagram.com/' + this.options.username +
            '\' rel=\'noopener\' target=\'_blank\'>@' +
            this.options.username + '</a>)</p>'
      ...
      if (this.options.display_gallery) {
        var image_index = typeof image_sizes[this.options.image_size] !== 'undefined'
        ...
        if (typeof data.is_private !== 'undefined' && data.is_private === true) {
          ...
          for (var i = 0; i < max; i++) {
            ...
            html += '<a href=\'' + url + (this.options.display_captions ? '\' data-caption=\'' + caption : '') +
              '\' class=\'instagram-' + type_resource + '\' rel=\'noopener\' target=\'_blank\'' +
              styles.gallery_image_link +
              '>'
            html += '<img' + (this.options.lazy_load ? ' loading=\'lazy\'' : '') + ' src=\'' + image + '\' alt=\'' +
              caption + '\'' + styles.gallery_image + ' />'
            html += '</a>'
          }
      ...
      if (this.options.display_igtv && typeof data.edge_felix_video_timeline !== 'undefined') {
        ...
        if (igtv.length > 0) {
          ...
          for (var i = 0; i < max; i++) {
            ...
            html += '<a href=\'' + url + (this.options.display_captions ? '\' data-caption=\'' + caption : '') +
              '\' rel=\'noopener\' target=\'_blank\'' + styles.gallery_image_link + '>'
            html += '<img' + (this.options.lazy_load ? ' loading=\'lazy\'' : '') + ' src=\'' +
              igtv[i].node.thumbnail_src +
              '\' alt=\'' + caption + '\'' + styles.gallery_image + ' />'
            html += '</a>'
          }
          html += '</div>'
        }
    ...
    this.run = function () {
      this.get(function (data, instance) {
        ...
        if (typeof instance.options.callback === 'function') {
          let html = instance.display(data)
          instance.options.callback(data, html)
        }
      })
    }
