...
class ContributionCertificateView(LoginRequiredMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if not kwargs.get("object"):  # Create new one
            ...
            ContributionCertificate.objects.filter(user=user, autogenerated=True, is_signed_off=False).delete()
            cert: ContributionCertificate = user.gen_contribution_certificate()
        else:
            cert = kwargs["object"]
