...
class PublicationType(models.Model):
    """ Represents a type of publication, e.g. The Pulse"""
    type = models.CharField(max_length=256,
                            help_text="Type of publication, e.g. 'The Pulse' or 'Student Survival Guide'")
    machine_type = models.CharField(max_length=256, help_text="Machine readable type, autogenerated from type",
                                    blank=False, null=True)
    display_description = tinymce_models.HTMLField(
        help_text="The description to show on the publications page above the publications", default="")

    def __repr__(self):
        return f"<PublicationType: '{self.type}'>"
    ...
    def save(self, force_insert=False, force_update=False, using=None,
             update_fields=None):
        self.machine_type = slugify(self.type)
