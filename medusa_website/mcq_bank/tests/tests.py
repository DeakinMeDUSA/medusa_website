...
from .models import Category, Progress, Quiz, Sitting, SubCategory
from .views import CategoriesListView, QuizDetailView, QuizListView, anon_session_score
...
class TestTemplateTags(TestCase):
    ...
    def test_correct_answer_all_anon(self):
        ...
        self.assertTemplateUsed("mcq_bank/correct_answer.html")
