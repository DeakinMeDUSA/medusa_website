...
def SetupOptionParser():
    ...
    parser.add_option("--user", default=None, help="email address of user whose account is being " "accessed")
    parser.add_option(
        "--quiet",
        action="store_true",
        default=False,
...
def main():
    ...
    if options.refresh_token:
        ...
        TestImapAuthentication(
            options.user, GenerateOAuth2String(options.user, options.access_token, base64_encode=False)
        )
