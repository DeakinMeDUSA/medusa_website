...
class CommitteePosition(models.Model):
    ...
    sub_committee = models.ForeignKey(to=SubCommittee, on_delete=models.CASCADE, related_name="members",
                                      help_text="Subcommittee the position belongs to")
    profile_pic = models.ImageField(upload_to="org_chart/images", null=True, blank=True,
                                    help_text="Profile pic of the current committee member")
